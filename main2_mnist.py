...
if __name__ == '__main__':
  ...
  outputs_dir = "outputs/MNIST/Run4_minus_k/L2"
  ...
  train_loader = DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True, drop_last=True, pin_memory=True, num_workers=2 if torch.cuda.is_available() else 0) 
  test_loader  = DataLoader(dataset=test_dataset,  batch_size=20, shuffle=False, drop_last=True, pin_memory=True, num_workers=2 if torch.cuda.is_available() else 0) 
